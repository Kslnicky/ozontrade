...
import me.hikaricp.yellowexchange.exchange.repository.user.UserFavoriteCoinsRepository;
...
import me.hikaricp.yellowexchange.panel.admin.repository.AdminLegalSettingsRepository;
...
import me.hikaricp.yellowexchange.panel.worker.repository.WorkerLegalSettingsRepository;
...
public class ExchangeController {
    ...
    public String indexController(Model model, Authentication authentication, HttpServletRequest request, @RequestHeader("host") String host, @RequestParam(name = "lang", required = false) String lang) {
        ...
        model.addAttribute("googlepixel", domain == null ? "" : domain.getGooglepixel());
