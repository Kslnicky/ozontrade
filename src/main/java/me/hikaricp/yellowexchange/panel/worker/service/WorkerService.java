package me.hikaricp.yellowexchange.panel.worker.service;
...
import me.hikaricp.yellowexchange.exchange.repository.user.UserRequiredDepositCoinRepository;
...
public class WorkerService {
    ...
    public Worker createWorker(User user) {
        ...
        workerErrorMessages.setP2pMessage(adminErrorMessages.getP2pMessage());
    ...
    public void deleteWorker(Worker worker) {
        ...
        workerCryptoLendingRepository.deleteAllByWorkerId(worker.getId());
